...
export default function Login({ onClose, onGotoRegister }) {
  ...
  return (
    <>
      {/* <!-- login container --> */}
      <div class="flex flex-row-reverse rounded-2xl max-w-3xl p-0 items-center">
        {/* <!-- form --> */}
        <div class="md:w-1/2 px-8 md:px-16">
          <h2 class="text-2xl font-medium text-gray-600">Login</h2>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <button class="bg-orange-500 rounded-xl text-white py-2 hover:scale-105 duration-300">
              Login
            </button>
          </form>
          ...
          <button class="bg-white border py-2 w-full rounded-xl mt-3 flex justify-center items-center text-sm hover:scale-105 duration-300 text-[#002D74]">
            <svg
              class="mr-3"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 48 48"
          ...
          <div class="text-xs text-orange-500 border-b border-orange-400 py-4">
        ...
        <div class="md:block hidden w-1/2">
          <img className="rounded-2xl" alt="loginimg" src={logimg} />
        </div>
      </div>
    </>
  );
